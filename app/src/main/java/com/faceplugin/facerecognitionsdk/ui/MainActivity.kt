...
import com.faceplugin.facerecognitionsdk.kit.LicenseStatus
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<LinearLayout>(R.id.ll_enroll).setOnClickListener {
            ...
            if (!LicenseStatus.current().recognition) {
        ...
        if (client.isEngineReady) {
            ...
            textWarning.setBackgroundResource(R.color.status_info)
            ...
            client.activate(LICENSE_KEY) { code ->
                runOnUiThread {
                    ...
                    if (code == FaceRecognitionSDK.SDK_SUCCESS) {
                        ...
                        sdkReady = false
                        textWarning.visibility = View.VISIBLE
                        textWarning.setBackgroundResource(R.color.md_theme_light_error)
    ...
    private fun applySdkReady() {
        ...
        textWarning.visibility = View.VISIBLE
        textWarning.setBackgroundResource(R.color.status_ok)
        textWarning.text = getString(R.string.sdk_ready_with_license, status.label)
    ...
    private fun applyLicenseTiles(status: LicenseStatus) {
        setTileEnabled(findViewById(R.id.ll_enroll), status.recognition)
        setTileEnabled(findViewById(R.id.ll_identify), status.recognition)
        setTileEnabled(findViewById(R.id.ll_capture), status.liveness)
        setTileEnabled(findViewById(R.id.ll_attribute), status.recognition)
    }

    private fun setTileEnabled(button: View, enabled: Boolean) {
